...
class CreateVoteCountAsistSecGensTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('vote_count_asist_sec_gens', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::dropIfExists('vote_count_asist_sec_gens');
    }
}
