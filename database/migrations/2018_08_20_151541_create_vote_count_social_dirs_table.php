...
class CreateVoteCountSocialDirsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('vote_count_social_dirs', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::dropIfExists('vote_count_social_dirs');
    }
}
