...
class CreateVoteCountProCandTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    {
        Schema::dropIfExists('vote_count_pro_cand');
    }
}
