...
class CreateVoteCountVicePresidentsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('vote_count_vice_presidents', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::dropIfExists('vote_count_vice_presidents');
    }
}
